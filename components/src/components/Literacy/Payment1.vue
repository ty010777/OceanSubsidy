    ...
    <div class="block">
        ...
        <div class="table-responsive mb-0">
            <table class="table align-middle gray-table">
                ...
                <tbody>
                    <tr>
                        <td class="text-end">{{ project.ApprovedAmount }}</td>
...
<script setup>
    ...
    const docs = ref([
        { Type: 11, Title: "領據", Template: "../../Template/LIT/1-領據.docx", Files: [] }
    ]);
    ...
    const add = (item, file) => {
        if (file.Type === "application/pdf") {
            item.Files.push({
                Type: item.Type,
                Path: file.Path,
                Name: `${project.value.ProjectID}_請款_${item.Title}.pdf`
            });
        }
    };
    ...
    const save = (submit) => {
        const data = {
            Payment: {
                ...
                CurrentRequestAmount: project.value.ApprovedAmount
            },
