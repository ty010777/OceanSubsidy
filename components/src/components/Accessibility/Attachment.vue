...
<script setup>
    ...
    const docs = ref([
        ...
        { Type: 4, Title: "未違反公職人員利益衝突迴避法切結書及事前揭露表", Template: "../../Template/ACC/附件04-未違反公職人員利益衝突迴避法切結書及事前揭露表.docx", Files: [] },
    ...
    const downloadTemplate = (idx) => {
        ...
        if (doc?.Template) {
            window.open(`/Service/OFS/DownloadTemplateACC.ashx?type=${doc.Type}&id=${props.id}`);
        }
    };
