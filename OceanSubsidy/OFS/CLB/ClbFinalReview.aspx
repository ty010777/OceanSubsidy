<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClbFinalReview.aspx.cs" Inherits="OFS_CLB_Review_ClbFinalReview" Culture="zh-TW" UICulture="zh-TW" MasterPageFile="~/OFSMaster.master" EnableViewState="true" %>
<%@ Register TagPrefix="uc" TagName="ClbApplicationControl" Src="~/OFS/CLB/UserControls/ClbApplicationControl.ascx" %>

<asp:Content ID="TitleContent" ContentPlaceHolderID="TitleContent" runat="server">
    社團補助案決審核定 - 海洋領域補助計畫管理資訊系統
</asp:Content>
    ...
    <div class="page-title">
        ...
        <div>
            ...
            <div class="d-flex align-items-end gap-3">
                <h2 class="text-teal-dark">社團補助案決審核定</h2>
...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadExtra" runat="server">
    ...
    <script src="<%= ResolveUrl("~/script/OFS/CLB/ClbFinalReview.js") %>"></script>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="scroll-bottom-panel" id="scrollBottomPanel" runat="server" >
        <h5 class="text-pink fs-18 fw-bold mb-3">決審核定結果</h5>
