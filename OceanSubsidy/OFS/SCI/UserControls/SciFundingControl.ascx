...
<div class="anchor-wrapper">
    ...
    <div class="anchor-menu">
        ...
        <a href="#point4-1" class="anchor-menu-item">4-1.國內差旅費</a>
        <% if (ShowForeignTravel) { %>
...
<div class="block">
    ...
    <div id="point1">
        ...
        <div class="table-responsive mt-3 mb-0">
            <table class="table align-middle gray-table person" id ="point1Table">
                ...
                <tr>
                    ...
                    <th class="text-end">
                        <span class="text-pink view-mode">*</span>平均月薪(元)
                        <button type="button" class="btn-tooltip" data-bs-toggle="modal" data-bs-target="#PersonJobSalaryModal">
                            <i class="fas fa-info-circle"></i>
                        </button>
                    </th>
        ...
        <ul class="list-unstyled lh-base">
            ...
            <li>2.應規劃提升海洋科技研發人員薪資機制或建置友善職場環境(如加薪規則、升遷管道、激勵措施及工作環境硬體設施等)。</li>
            <li>3.計畫所列海洋科技研發人員之實領薪資應高於或等於平均月薪。</li>
            <li>4.若有共同執行單位(企業)經費投入請編列至配合款，並於本表備註為共同執行單位之人員。</li>
            <li>5.所列人員須為申請人正式員工（具其勞保身份者），員工數不足5人(不含)以下，未具參加勞工保險投保資格者(已符合年資或退休)，須檢附證明文件(如職業災害保險)。</li>
        </ul>
    </div>
    ...
    <div id="point2">
        ...
        <div class="table-responsive mt-3 mb-0">
            <table class="table align-middle gray-table Material" id = "point2Table">
                <thead>
                <tr>
                    <th><span class="text-pink view-mode">*</span>品名</th>
    ...
    <div id="point4-2">
        ...
        <div class="table-responsive mt-3 mb-0">
            <table class="table align-middle gray-table foreignTravel" id="foreignTravelTable">
                <thead>
                <tr>
                    <th width="150"><span class="text-pink view-mode">*</span>擬前往國家或地區</th>
                    <th width="250"><span class="text-pink view-mode">*</span>主要會議議題</th>
        ...
        <div class="table-responsive mt-3 mb-0">
            <table class="table align-middle gray-table other" id="otherTable">
                ...
                <tr>
                    ...
                    <th class="text-end">
                        平均月薪(元)
                        <button type="button" class="btn-tooltip" data-bs-toggle="modal" data-bs-target="#otherJobSalaryModal">
                            <i class="fas fa-info-circle"></i>
                        </button>
                    </th>
                    <th class="text-end">參與人月</th>
                    <th class="text-end">人數</th>
                    <th class="text-end">人事費小計(元)</th>
                    <th width="150">功能</th>
                </tr>
                </thead>
                <tbody>
...
<!-- Modal 其他業務費月薪上限說明 -->
<div class="modal fade" id="otherJobSalaryModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="otherJobSalaryModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="otherJobSalaryModalLabel">各職稱月薪上限</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <i class="fa-solid fa-circle-xmark"></i>
                </button>
            </div>
                    ...
                    <table class="table table-bordered">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-center">月薪上限(元)</th>
                            </tr>
                        </thead>
                        <tbody id="otherJobSalaryTableBody">
                            <!-- 資料將由後端動態產生 -->
                        </tbody>
                    </table>
                </div>
...
<!-- Modal 海洋科技研發人員人事費明細表月薪上限說明 -->
<div class="modal fade" id="PersonJobSalaryModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="PersonJobSalaryModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="PersonJobSalaryModalLabel">各職稱月薪上限</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <i class="fa-solid fa-circle-xmark"></i>
                </button>
            </div>
            <div class="modal-body">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody id="PersonJobSalaryTableBody">
                            <!-- 資料將由後端動態產生 -->
                        </tbody>
                    </table>
                </div>
