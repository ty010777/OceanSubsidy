<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplicationChecklist.aspx.cs" Inherits="OFS_ApplicationChecklist" Culture="zh-TW" UICulture="zh-TW" %>
    ...
    <style>
      ...
      <script type="text/javascript">
            ...
            function initTabs() {
                ...
                tabs.forEach(function(tab, index) {
                    tab.addEventListener('click', function() {
                        ...
                        // 取得選中的申請類別
                        const categoryText = tab.querySelector('.tab-title').textContent;
                        
                        // 設定隱藏欄位的值
                        document.getElementById('<%= hidSelectedStage.ClientID %>').value = categoryText;
            ...
            function updateTabCounts(counts) {
                const categories = ['總申請', '科專', '文化', '學校民間', '學校社團'];
                const tabs = document.querySelectorAll('.tab-item');
        ...
        <div class="container">
            ...
            <div class="tabs-container">
                <div class="tab-item active">
                    <div class="tab-title">總申請</div>
                    <div class="tab-count">0<span class="tab-unit">件</span></div>
                </div>
                <div class="tab-item">
                    <div class="tab-title">科專</div>
                    <div class="tab-count">0<span class="tab-unit">件</span></div>
                </div>
                <div class="tab-item">
                    <div class="tab-title">文化</div>
                    <div class="tab-count">0<span class="tab-unit">件</span></div>
                </div>
                <div class="tab-item">
                    <div class="tab-title">學校民間</div>
                    <div class="tab-count">0<span class="tab-unit">件</span></div>
                </div>
                <div class="tab-item">
                    <div class="tab-title">學校社團</div>
                    <div class="tab-count">0<span class="tab-unit">件</span></div>
                </div>
            </div>
