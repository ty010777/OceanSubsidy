                                          ...
                                          <div class="row g-4">
                                              <div class="col-12 col-md-3">
                                                  ...
                                                  <div class="form-check-input-group mt-3 d-flex">
                                                      ...
                                                      <%-- <asp:RadioButton ID="rbUnderwaterYes" runat="server" GroupName="Underwater" Text="是" /> --%>
                                                      <%-- <asp:RadioButton ID="rbUnderwaterNo" runat="server" GroupName="Underwater" Text="否" /> --%>
                                              ...
                                              <div class="col-12 col-md-3">
                                                  ...
                                                  <div class="form-check-input-group mt-3 d-flex">
                                                      ...
                                                      <%-- <asp:RadioButton ID="rbMarineYes" runat="server" GroupName="Marine" Text="是" />  --%>
                                                      <%-- <asp:RadioButton ID="rbMarineNo" runat="server" GroupName="Marine" Text="否" /> --%>
                                                  </div>
                                              </div>
                                              <div class="col-12 col-md-3">
                                                  ...
                                                  <div class="form-check-input-group mt-3 d-flex">
                                                      ...
                                                      <%-- <asp:RadioButton ID="rbPhysicsYes" runat="server" Cssclass="form-check-input blue-green-check" GroupName="Physics" Text="是" />  --%>
                                                      <%-- <asp:RadioButton ID="rbPhysicsNo" runat="server"  Cssclass="form-check-input blue-green-check" GroupName="Physics" Text="否" />  --%>
                                                  </div>
                                              </div>
                                          </div>
                                      </td>
