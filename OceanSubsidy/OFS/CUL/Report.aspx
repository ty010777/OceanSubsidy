...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <div>
        ...
        <template :key="item" v-for="(item) in stages">
            <project-report :data="item" :id="id" @next="next" type="culture" v-if="item.id === stage"></project-report>
        </template>
    </div>
</asp:Content>

<asp:Content ContentPlaceHolderID="FloatContent" runat="server">
    <project-report-review :id="id" :stage="stage" type="culture" v-if="store.culture.reportStatus === '審核中'"></project-report-review>
    <script>
        setupVueApp({
            setup() {
