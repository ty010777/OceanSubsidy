<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Payment.aspx.cs" Inherits="OFS_CulPayment" Culture="zh-TW" UICulture="zh-TW" MasterPageFile="~/OFS/CUL/Layout.master" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <div v-if="settings">
        ...
        <project-progress :id="id" :step="6" type="culture"></project-progress>
        ...
        <culture-payment1 :id="id" :setting="settings[0]" v-on:next="next" v-if="stage === 1"></culture-payment1>
        <culture-payment2 :id="id" :setting="settings[1]" v-on:next="next" v-else-if="stage === 2"></culture-payment2>
    </div>
</asp:Content>

<asp:Content ContentPlaceHolderID="FloatContent" runat="server">
    <project-payment-review :id="id" type="culture"></project-payment-review>
    <script>
        setupVueApp({
            setup() {
                ...
                onMounted(() => {
                    api.culture("getPaymentPhaseSettings", { TypeCode: "CUL" }).subscribe((res) => settings.value = res);
