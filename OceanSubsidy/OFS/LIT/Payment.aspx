        ...
        <div class="block rounded-top-4 pb-0">
            <ul class="teal-dark-tabs mb-0">
                <li :class="{ active: stage === 1, disabled: false }">
                    <a class="tab-link" href="javascript:void(0)" v-on:click="stage = 1">請款</a>
                </li>
                <li :class="{ active: stage === 2, disabled: false }">
                    <a class="tab-link" href="javascript:void(0)" v-on:click="stage = 2">結案核銷</a>
                </li>
            </ul>
        </div>
        <literacy-payment1 :id="id" v-on:next="next" v-if="stage === 1"></literacy-payment1>
        <literacy-payment2 :id="id" v-on:next="next" v-else-if="stage === 2"></literacy-payment2>
    </div>
</asp:Content>
