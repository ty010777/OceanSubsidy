    ...
    <div class="mt-3">
        <nav>
            <div class="tab" role="tablist">
                ...
                <button :aria-selected="stage === 4 ? 'true' : 'false'" class="tab-link" :class="{ active: stage === 4 }" v-on:click="stage = 4" role="tab" type="button" v-if="id">審查委員</button>
            </div>
        </nav>
