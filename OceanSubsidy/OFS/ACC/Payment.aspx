...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <div v-if="settings">
        ...
        <accessibility-payment1 :id="id" :setting="settings[0]" v-on:next="next" v-if="stage === 1"></accessibility-payment1>
        <accessibility-payment2 :id="id" :setting="settings[1]" v-on:next="next" v-else-if="stage === 2"></accessibility-payment2>
    </div>
</asp:Content>

<asp:Content ContentPlaceHolderID="FloatContent" runat="server">
    <project-payment-review :id="id" type="accessibility"></project-payment-review>
    <script>
        setupVueApp({
            setup() {
                ...
                onMounted(() => {
                    api.accessibility("getPaymentPhaseSettings", { TypeCode: "ACC" }).subscribe((res) => settings.value = res);
