<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReviewerList2.aspx.cs" Inherits="Report_ReviewerList2" Culture="zh-TW" UICulture="zh-TW" MasterPageFile="~/OFS/CUL/Layout.master" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <report-reviewer-details :id="id" type="2"></report-reviewer-details>
    <script>
        setupVueApp({
            setup() {
