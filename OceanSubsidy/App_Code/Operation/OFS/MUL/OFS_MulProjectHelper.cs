...
public class OFS_MulProjectHelper
{
    ...
    {
        return query(new OFS_MulProject { ID = id }, false).FirstOrDefault();
    }
    ...
    public static List<OFS_MulProject> query(OFS_MulProject conditions, bool valid = true)
    {
        DbHelper db = new DbHelper();
    ...
    public static void reviewApplication(OFS_MulProject model)
    {
        DbHelper db = new DbHelper();
