...
public class OFSNewsImageHelper
{
    ...
    public static void insert(NewsImage model)
    {
        DbHelper db = new DbHelper();

        db.CommandText = @"
            INSERT INTO [OFS_News_Image] ([NewsID],[Path],[Name],[CreateTime],[CreateUser])
    ...
    public static List<NewsImage> query(int newsId)
    {
        DbHelper db = new DbHelper();
    ...
    private static NewsImage toModel(DataRow row)
    {
