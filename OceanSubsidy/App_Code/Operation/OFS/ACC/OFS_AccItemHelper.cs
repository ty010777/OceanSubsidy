...
public class OFS_AccItemHelper
{
    ...
    public static void insert(OFS_AccItem model)
    {
        DbHelper db = new DbHelper();

        db.CommandText = @"
            INSERT INTO [OFS_ACC_Item] ([PID],[Title],[Begin],[End],[Deadline],[Content],[CreateTime],[CreateUser])
    ...
    public static List<OFS_AccItem> query(int pid)
    {
        DbHelper db = new DbHelper();
    ...
    public static void update(OFS_AccItem model)
    {
        DbHelper db = new DbHelper();
    ...
    private static OFS_AccItem toModel(DataRow row)
    {
        return new OFS_AccItem
        {
            ID = row.Field<int>("ID"),
