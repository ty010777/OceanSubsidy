...
public class OFS_AccProjectHelper
{
    ...
    public static OFS_AccProject get(int id)
    {
        return query(new OFS_AccProject { ID = id }, false).FirstOrDefault();
    }
    ...
    public static void insert(OFS_AccProject model)
    {
        DbHelper db = new DbHelper();

        db.CommandText = @"
            INSERT INTO [OFS_ACC_Project] ([Year],[ProjectID],[SubsidyPlanType],[ProjectName],[OrgName],[OrgCategory],[RegisteredNum],[TaxID],[Address],[Target],
                ...
                OUTPUT Inserted.ID VALUES (@Year, @ProjectID, @SubsidyPlanType, @ProjectName, @OrgName, @OrgCategory, @RegisteredNum, @TaxID, @Address, @Target,
    ...
    public static List<OFS_AccProject> query(OFS_AccProject conditions, bool valid = true)
    {
        DbHelper db = new DbHelper();
    ...
    public static void updateBenefit(OFS_AccProject model)
    {
        DbHelper db = new DbHelper();
    ...
    public static void updateFunding(OFS_AccProject model)
    {
        DbHelper db = new DbHelper();
    ...
    private static OFS_AccProject toModel(DataRow row)
    {
        return new OFS_AccProject
        {
            ID = row.Field<int>("ID"),
