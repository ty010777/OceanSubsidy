...
public class OFS_AccBenefitHelper
{
    ...
    public static void insert(OFS_AccBenefit model)
    {
        DbHelper db = new DbHelper();

        db.CommandText = @"
            INSERT INTO [OFS_ACC_Benefit] ([PID],[Title],[Target],[Description],[CreateTime],[CreateUser])
    ...
    public static List<OFS_AccBenefit> query(int pid)
    {
        DbHelper db = new DbHelper();
    ...
    public static void update(OFS_AccBenefit model)
    {
        DbHelper db = new DbHelper();

        db.CommandText = @"
            UPDATE [OFS_ACC_Benefit]
               SET [Title] = @Title
                  ,[Target] = @Target
    ...
    private static OFS_AccBenefit toModel(DataRow row)
    {
        return new OFS_AccBenefit
        {
            ID = row.Field<int>("ID"),
