...
namespace GS.OCA_OceanSubsidy.Entity.Base
{
    ...
    public class IOFS_SCI_StageExam : IMeta
    {
        ...
        protected string _ReviewMethod = "";
        ///<summary>
        ///  ()
        ///</summary>
        [DataMember]
        [GisFieldAttribute("ReviewMethod", "ReviewMethod", DataSource.TABLE, "", false)]
        public virtual string ReviewMethod
        {
            get
            {
                return _ReviewMethod;
            }
            set
            {
                bool isModify = false;
                if (_ReviewMethod == null) {
                    if(value != null) {
                        isModify = true;
                    }
                }
                else if (!_ReviewMethod.Equals(value))
                {
                    isModify = true;
                }
                if(isModify) {
                    MetaDataState = DataState.UPDATE;
                    if (UPDATE_COLUMN.IndexOf("ReviewMethod") == -1)
                    {
                        UPDATE_COLUMN.Add("ReviewMethod");
                    }
                    _ReviewMethod = value;
                }
            }
...
namespace GS.OCA_OceanSubsidy.Entity
{
    ...
    [DataContract]
    [Serializable()]
    public partial class OFS_SCI_StageExam : IOFS_SCI_StageExam
    {
    }
