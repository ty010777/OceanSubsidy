...
namespace GS.OCA_OceanSubsidy.Entity.Base
{
    ...
    [DataContract]
    [Serializable()]
    [GisTableAttribute("OFS_SCI_Payment", "", false)]
    public class IOFS_SCI_Payment : IMeta
    {
        ...
        protected decimal? _ActDisbursementRatioPct = null;
        ///<summary>
        ///  ()
        ///</summary>
        [DataMember]
        [GisFieldAttribute("ActDisbursementRatioPct", "ActDisbursementRatioPct", DataSource.TABLE, "", false)]
        public virtual decimal? ActDisbursementRatioPct
        {
            get
            {
                return _ActDisbursementRatioPct;
            }
            set
            {
                bool isModify = false;
                if (_ActDisbursementRatioPct == null) {
                    if(value != null) {
                        isModify = true;
                    }
                }
                else if (!_ActDisbursementRatioPct.Equals(value))
                {
                    isModify = true;
                }
                if(isModify) {
                    MetaDataState = DataState.UPDATE;
                    if (UPDATE_COLUMN.IndexOf("ActDisbursementRatioPct") == -1)
                    {
                        UPDATE_COLUMN.Add("ActDisbursementRatioPct");
                    }
                    _ActDisbursementRatioPct = value;
                }
            }
        }
...
namespace GS.OCA_OceanSubsidy.Entity
{
    ...
    [DataContract]
    [Serializable()]
    public partial class OFS_SCI_Payment : IOFS_SCI_Payment
    {
    }
