...
namespace GS.OCA_OceanSubsidy.Entity.Base
{
    ...
    [DataContract]
    [Serializable()]
    [GisTableAttribute("OFS_SCI_Version", "", false)]
    public class IOFS_SCI_Version : IMeta
    {
        ...
        ///</summary>
        [DataMember]
        [GisFieldAttribute("ProjectID", "ProjectID", DataSource.TABLE, "計畫原ID(最原始的ID 版控用)", false)]
        ...
        ///<summary>
        /// 計畫ID(依版本變更) (計畫ID(依版本變更))
        ///</summary>
        [DataMember]
        [GisFieldAttribute("Version_ID", "Version_ID", DataSource.TABLE, "計畫ID(依版本變更)", false)]
        ...
        protected int? _VersionNum = null;
        ///<summary>
        /// 第幾版 (第幾版)
        ///</summary>
        [DataMember]
        [GisFieldAttribute("VersionNum", "VersionNum", DataSource.TABLE, "第幾版", false)]
        public virtual int? VersionNum
        {
            get
            {
                return _VersionNum;
            ...
            set
            {
                ...
                else if (!_VersionNum.Equals(value))
                {
                    isModify = true;
                }
                if(isModify) {
                    MetaDataState = DataState.UPDATE;
                    if (UPDATE_COLUMN.IndexOf("VersionNum") == -1)
                    {
                        UPDATE_COLUMN.Add("VersionNum");
                    }
                    _VersionNum = value;
                }
            }
...
namespace GS.OCA_OceanSubsidy.Entity
{
    ...
    [DataContract]
    [Serializable()]
    public partial class OFS_SCI_Version : IOFS_SCI_Version
    {
    }
